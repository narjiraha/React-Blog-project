...
import FitnessData from "./FitnessPage.json";
...
const FitnessPage = () => {
    ...
    const topNewsData = [
      {
        ...
        "description": "In a recent interview, director Apoorva Lakhia, known for the film 'Zanjeer,' discussed his friendship with actor Ram Charan, who made his Fitness debut in the same film. Despite the box office failure of 'Zanjeer,' Lakhia revealed that he and Ram Charan ha…",
      ...
      },
      {
        ...
        "description": "Disha Patani is one of the fittest actresses in Fitness. A look into her workout sessions that will surely make you sweat.",
      ...
      },
      {
        ...
        "description": "Fitness actress Sara Ali Khan visited Mahakaleshwar Temple in Ujjain, Madhya Pradesh, to participate in the famous 'Bhasma Aarti' ritual. She wore a magenta-pink saree, following the temple's dress code for the ritual, and performed 'Jalabhishek'.",
      ...
      },
      {
        ...
        "description": "Aamir Khan, Fitness's superstar, has stated that he is not \"emotionally ready\" to work in his next film yet. Following the weak response to his latest film, 'Laal Singh Chaddha,' the actor decided to take a break from acting to prioritise his family.",
  ...
  return (
    <div className="Fitness-page">
      <div className="Fitness-news-container">
        <div className="Fitness-news-section-left-container">
          <h2>Fitness News</h2>
          {FitnessNews && FitnessNews.length > 0 ? (
            FitnessNews.slice(0, 13).map((news, index) => (
            ...
            <p>No Fitness news found.</p>
          )}
          {FitnessNews.length > numToShow && (
