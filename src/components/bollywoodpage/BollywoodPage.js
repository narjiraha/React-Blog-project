...
import "./BollywoodPage.css";
import bollywoodData from "./BollywoodPage.json";
...
const BollywoodPage = () => {
    ...
    const topNewsData = [
      {
        ...
        "description": "In a recent interview, director Apoorva Lakhia, known for the film 'Zanjeer,' discussed his friendship with actor Ram Charan, who made his Bollywood debut in the same film. Despite the box office failure of 'Zanjeer,' Lakhia revealed that he and Ram Charan ha…",
      ...
      },
      {
        ...
        "description": "Bollywood actress Sara Ali Khan visited Mahakaleshwar Temple in Ujjain, Madhya Pradesh, to participate in the famous 'Bhasma Aarti' ritual. She wore a magenta-pink saree, following the temple's dress code for the ritual, and performed 'Jalabhishek'.",
  ...
  return (
    <div className="bollywood-page">
      <div className="bollywood-news-container">
        <div className="bollywood-news-section-left-container">
          <h2>Bollywood News</h2>
          {bollywoodNews && bollywoodNews.length > 0 ? (
            bollywoodNews.slice(0, 10).map((news, index) => (
            ...
            <p>No Bollywood news found.</p>
          )}
          {bollywoodNews.length > numToShow && (
